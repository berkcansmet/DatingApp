    ...
    return (
      <View style={styles.container}>
        <Header barStyle={'light-content'} backgroundColor={'transparent'}>
          ...
          <View>
            <Text style={styles.bannerText}>Guk App Diamond</Text>
          </View>
        </Header>
        <View style={styles.balaceBuyContainer}>
          <View style={styles.balaceBuy}>
            <Text style={styles.balaceBuyText}>100 Diamond</Text>
          ...
          <View style={styles.balaceBuy}>
            <Text style={styles.balaceBuyText}>500 Diamond</Text>
            <View style={styles.checkBoxContainer}>
              <CheckBox
                onPress={() => this.setState({checked: !this.state.checked})}
                checked={this.state.checked}
          ...
          <View style={styles.balaceBuy}>
            <Text style={styles.balaceBuyText}>750 Diamond</Text>
            <View style={styles.checkBoxContainer}>
              <CheckBox
                onPress={() => this.setState({checked: !this.state.checked})}
                checked={this.state.checked}
